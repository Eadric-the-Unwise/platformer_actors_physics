...
const actor_t level1_actors[5] = {
    ...
    {.x = TO_COORDS(136),
     ...
     .SpdX = 0,
     .SpdY = -16,
     .w = detective_large_WIDTH - 8,
     .h = detective_large_HEIGHT - 16,
    ...
    {.x = TO_COORDS(-185),
     ...
     .SpdX = 0,
     .SpdY = 0,
     .w = enemy_arrow_WIDTH + 12,
     .h = enemy_arrow_HEIGHT - 6,
     .direction = DIR_LEFT,
     .NPC_type = PISTOL,
    ...
    {.x = TO_COORDS(-464 + (vertical_platform_V1_WIDTH - 16)),
     ...
     .SpdX = 0,
     .SpdY = 16,
     .w = vertical_platform_V1_WIDTH - 8,
     .h = vertical_platform_V1_HEIGHT + 8,
     .direction = DIR_RIGHT,
     .NPC_type = ELEVATOR,
