...
void main()
{
    ...
    SHOW_BKG;
    SHOW_SPRITES;
    JOYLOCK = ANIMATIONLOCK = GAMEOVER = EXIT1 = EXIT2 = Gravity = L_LEFT = L_RIGHT = ATTACH = LADDER = ONTO_Ladder = DOWN_LADDER = DOWN_LADDER_F = UP_LADDER = OFF_LADDER = CROUCH = canCROUCH = DROP = FALSE;
