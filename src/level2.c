...
#define lvl2_CAM1_COUNT 2
#define lvl2_CAM2_COUNT 1
#define lvl2_CAM3_COUNT 2
#define lvl2_CAM4_COUNT 1
UINT8 lvl2_cam1_render[3] = {0, 1, 2};
UINT8 lvl2_cam2_render[2] = {0, 3};
UINT8 lvl2_cam3_render[3] = {0, 3, 4};
UINT8 lvl2_cam4_render[2] = {0, 4};
UINT8 lvl2_cam1[lvl2_CAM1_COUNT] = {1, 2};
UINT8 lvl2_cam2[lvl2_CAM2_COUNT] = {3};
UINT8 lvl2_cam3[lvl2_CAM3_COUNT] = {3, 4};
UINT8 lvl2_cam4[lvl2_CAM4_COUNT] = {4};
...
void anim_level2() {
    ...
    if ((camera_x >= 1280) && (camera_x <= bkg.camera_max_x)) {  // CAM1
        ...
        ptr = lvl2_cam1;
        nptr = lvl2_cam2;
    } else if ((camera_x >= 1120) && (camera_x < 1280)) {  // CAM2
        ...
        ptr = lvl2_cam2;
        nptr = lvl2_cam3;
    } else if ((camera_x >= 960) && (camera_x < 1120)) {  // CAM3
...
void spawn_bullets_lvl2(UINT8 bullet_number) {
    ...
    if (PLAYER.x < active_actors[active_bullets[bullet_number].actor].x) {  // BULLET IS VISIBLE BEFORE ITS X AXIS IS LESS THAN DETECTIVE
...
<<<<<<< HEAD
    ...
    for (UINT8 i = ACTOR_FIRST_NPC; i != (total_actors_count); i++) {
        == == == =
                     for (UINT8 i = ACTOR_FIRST_NPC; i != (total_actors_count); i++) {
>>>>>>> 5e56bfbbdcefd9aa9aa2bc3cf441001fd17d45b2
            //[y][x]
            UINT16 PTR_y, PTR_x, PBL_y, PBL_x, NTR_y, NTR_x, NBL_y, NBL_x;
            UINT8 ax, ay;
    ...
    void enter_lvl2() {
        ...
        while (GAMESTATE == 2) {
            ...
            // check_LADDER(px, py, TO_PIXELS(bkg.camera_x), LEVEL_2_COLLISION, LEVEL_2_COLLISIONWidth);
