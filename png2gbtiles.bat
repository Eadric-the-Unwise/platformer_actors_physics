@REM C:\c_code\gbdk\bin\png2gbtiles ..\tiles\bkg_forest1.png -csource bkg_forest1.c
@REM C:\c_code\gbdk\bin\png2gbtiles ..\tiles\bkg_forest1.png -csource -d -f -p bkg_forest1.gbm


@REM C:\c_code\projects\detective\detective_metasprite\build\gb_map_converter\gb_map_converter.exe -i ..\maps\bkg_apartment.png -n bkg_apartment -o ..\maps
...
C:\c_code\projects\detective\detective_metasprite\build\gb_map_converter\gb_map_converter.exe -i .\res\maps\cellar_2.png -n cellar_2 -o .\res\maps\